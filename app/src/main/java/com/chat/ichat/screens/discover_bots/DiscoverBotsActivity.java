...
// */
//public class DiscoverBotsActivity extends BaseActivity implements DiscoverBotsContract.View, DiscoverBotsAdapter.ActionListener {
//    @Bind(R.id.tb)
//    Toolbar toolbar;
//
//    @Bind(R.id.rv_bots)
...
//        startActivity(DiscoverCategoryActivity.callingIntent(this, botses));
//    }
//
//    @Override
