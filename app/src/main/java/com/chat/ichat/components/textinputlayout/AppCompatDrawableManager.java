...
public final class AppCompatDrawableManager {
    ...
    private static final AppCompatDrawableManager.ColorFilterLruCache COLOR_FILTER_CACHE = new AppCompatDrawableManager.ColorFilterLruCache(6);
        ...
        if (mDelegates != null && !mDelegates.isEmpty()) {
            ...
            if (tv.string != null && tv.string.toString().endsWith(".xml")) {
                ...
                try {
                    ...
                    final AppCompatDrawableManager.InflateDelegate delegate = mDelegates.get(tagName);
                    if (delegate != null) {
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context,
                ThemeUtils.getThemeAttrColor(context, R.attr.colorButtonNormal));
    }
