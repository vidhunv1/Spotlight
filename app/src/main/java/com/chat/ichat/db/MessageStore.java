...
import com.chat.ichat.db.core.SQLiteContract.MessagesContract;
...
//                    String chat_id = cursor.getString(cursor.getColumnIndex(MessagesContract.COLUMN_CHAT_ID));
    ...
    public Observable<Boolean> deleteChat(String chatId) {
        return Observable.create(subscriber -> {
            ...
            try{
                ...
                db.delete(MessagesContract.TABLE_NAME, selection, selectionArgs);
    ...
    public Observable<Boolean> deleteMessage(String receiptId) {
        return Observable.create(subscriber -> {
            SQLiteDatabase db = databaseManager.openConnection();
            String selection = MessagesContract.COLUMN_RECEIPT_ID + " = ?";
            String[] selectionArgs = {receiptId};
