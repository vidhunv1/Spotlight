...
public class RoundedCornerTransformation implements Transformation<Bitmap> {
    ...
    public RoundedCornerTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundedCornerTransformation(BitmapPool pool, int radius, int margin) {
