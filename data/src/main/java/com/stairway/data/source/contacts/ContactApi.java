...
public class ContactApi {
    public Observable<ContactResponse> initPhoneBook(List<ContactResult> contactResults, String authToken) {
        ContactEndpoint contactEndpoint = ApiManager.getInstance(authToken).create(ContactEndpoint.class);

        return contactEndpoint.createContact(new ContactRequest(contactResults));
    }
//
